...
&#x20;**Cách 1 :** Truy cập trang [builder.ladipage.com](http://builder.ladipage.com/), chọn menu **Tích hợp -> Tài khoản liên kết -> Tạo tài khoản liên kết.** Sau đó lựa chọn Loại tài khoản là **SendGrid**

{% embed url="https://prnt.sc/wfhZkPfqeuXU" %}

**Cách 2 :** Truy cập builder chỉnh sửa trang landingpage muốn lưu data về SendGrid, ở phần **Form đăng ký, mục Lưu data, bấm Thêm mới , chọn Tạo liên kết ->Loại tài khoản là SendGrid**\
